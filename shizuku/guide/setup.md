...
3. Tap "Pair device with pairing code" in "Wireless debugging"<br><img :src="$withBase('/images/start_pairing.png')" style="max-width:320;width:100">
...
<img :src="$withBase('/images/start_shizuku.png')" style="max-width:320;width:100">
